...
Using the ballr package in R, we will be able to extract NBA Team data from [basketballreference.com](https://www.basketball-reference.com/) directly into the console. To begin here are the library dependencies that will be used in this project.
